...
import { FaUserTie, FaPlus, FaPhone, FaEnvelope, FaEllipsisV, FaGraduationCap, FaChalkboardTeacher, FaSearch, FaFilter, FaTimes, FaEdit, FaTrash, FaEye, FaIdCard, FaBook, FaAward } from 'react-icons/fa';
                            ...
                            >
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="flex-1 px-3 py-2 bg-red-50 text-red-600 rounded-lg text-sm font-medium hover:bg-red-100 transition-colors flex items-center justify-center gap-2"
                                    >
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 sm:gap-4">
                        ...
                        <div className="flex gap-2 sm:gap-3">
                            ...
                            <button
                                ...
                                className="bg-blue-600 text-white px-4 sm:px-6 py-2 sm:py-2.5 rounded-xl font-medium flex items-center justify-center gap-2 hover:bg-blue-700 transition-all shadow-md text-sm whitespace-nowrap"
                            >
                                <FaPlus size={14} />
                    ...
                    >
                        <div className="flex flex-col items-center">
                            ...
                            {!(searchTerm || specialtyFilter !== "all") && (
                                <button
                                    onClick={() => setIsModalOpen(true)}
                                    className="mt-6 bg-blue-600 text-white px-4 sm:px-6 py-2 sm:py-2.5 rounded-xl font-medium flex items-center gap-2 hover:bg-blue-700 transition-all text-sm"
                                >
                        ...
                        >
                            ...
                            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-xl font-bold text-gray-800">Aperçu du formateur</h2>
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-emerald-50 rounded-xl p-6">
                                    <div className="flex items-start gap-4 flex-wrap">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="text-2xl font-bold text-gray-800">{previewTeacher.user?.name || 'Nom inconnu'}</h3>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="space-y-3">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-800 break-all">{previewTeacher.user?.email || 'Non renseigné'}</p>
                                            </div>
                                            <div>
                                                <p className="text-xs text-gray-500">Téléphone</p>
                                                <p className="text-sm text-gray-800">{previewTeacher.phone || 'Non renseigné'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="space-y-3">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-800">{previewTeacher.specialty || 'Non définie'}</p>
                                            </div>
                                            <div>
                                                <p className="text-xs text-gray-500">Expertise</p>
                                                <p className="text-sm text-gray-800">{previewTeacher.expertise || 'Non renseignée'}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {previewTeacher.bio && (
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <p className="text-sm text-gray-600 leading-relaxed">{previewTeacher.bio}</p>
                                    </div>
                                )}
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {previewTeacher.trainings.map((training: Training, index: number) => (
                                                <span key={index} className="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium bg-blue-100 text-blue-700">
...
const FaChevronLeft = ({ size, className }: { size?: number; className?: string }) => (
    <svg className={className} width={size || 10} height={size || 10} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <polyline points="15 18 9 12 15 6"></polyline>
    </svg>
);

const FaChevronRight = ({ size, className }: { size?: number; className?: string }) => (
    <svg className={className} width={size || 10} height={size || 10} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
